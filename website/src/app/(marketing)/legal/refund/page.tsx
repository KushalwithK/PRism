...
const sections: LegalSection[] = [
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>
            Your access to paid features continues until the end of your current
            billing period
          </li>
          <li>
            After the billing period ends, your account is automatically
      ...
      <>
        ...
        <ul>
          ...
          <li>
            ...
            mid-cycle plan downgrades. The lower plan takes effect at the start
      ...
      <>
        ...
        <ol>
          <li>
            ...
            <a href="/login">getlucent.dev/login</a>
          </li>
          <li>
            Navigate to your <strong>Dashboard</strong>
          </li>
          <li>
            Go to the <strong>Billing</strong> section
          </li>
          <li>
            Click <strong>Cancel</strong> on your active subscription
          </li>
        </ol>
        <p>
          Your cancellation takes effect immediately, but you retain access to
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>
            Your subscription ID (found in your billing dashboard)
          </li>
...
export default function RefundPolicyPage() {
  return (
    <LegalPage
      title="Refund & Cancellation Policy"
      description="Our straightforward policy on subscription cancellations, refunds, and plan changes."
